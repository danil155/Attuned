...
class IGDBClient:
    ...
    def fetch_all_games(self) -> Generator[list[IGDBGame], None, None]:
        ...
        print('Starting full IGDB games dump')
        ...
        while True:
            ...
            print(f'Fetched {total_fetched} games so far, last id={last_id}')

        print(f'Full dump complete: {total_fetched} games total')

    # обновляем access_token
    def _refresh_access_token(self) -> None:
        print('Refresh IGDB access token')
        ...
        print(f'IGDB token refreshed, expires at {self._token_expires_at}')
